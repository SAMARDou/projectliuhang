    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonSetup.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenuActivity.this, SerialPortPreferences.class));
			}
		});
/*        final Button buttonConsole = (Button)findViewById(R.id.ButtonConsole);
        ...
        buttonLoopback.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenuActivity.this, LoopbackActivity.class));
			}
		});
        ...
        button01010101.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenuActivity.this, Sending01010101Activity.class));
			}
		});
		...
		buttonAll.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenuActivity.this, WorkActivity.class));
			}
		});
    }
}
